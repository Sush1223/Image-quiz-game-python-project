...
root.iconbitmap(r"Imagequiz.ico")# THIS IS USED FOR CHANGING THE DEAFUALT FRAME ICON OF TKINTER FROM TK TO "IMAGEQUIZ"
...
lblimage1.after(30000,Closelabel)#THIS IS USED TO DISPLAY PICTURES FOR 30 SECONDS
